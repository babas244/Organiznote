    ...
    <body>
		...
		if (isset($_SESSION['id'])) {
			...
			while ($donnees = $req->fetch()) {
				...
				$topics .= "<div id=\"topic".$donnees['id']."\" class=\"unselectable\" style=\"Background-color : ".$donnees['colorBackGround'].";color : ".$donnees['colorFont']."\" onclick=\"document.location.href='manageNotes/manageNotes.php?idTopic=".$donnees['id']."'\">".$donnees['topic']."</div>";
			}
