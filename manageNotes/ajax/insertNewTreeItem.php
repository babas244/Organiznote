...
if (isset($_SESSION['id']) && isset($_GET["idTopic"]) && isset($_POST["newNote"]) && isset($_GET["sPathParent"]) && isset($_GET['itemType']) && isset($_GET["rankClientSide"])) {
	
	if ((preg_match("#^[0-9]{2}([a-b][0-9]{2})*$#", $_GET["sPathParent"])) && preg_match("#^[a-b]$#", $_GET["itemType"]) && preg_match("#^[0-9]+$#", $_GET["rankClientSide"])) {
